...
try 
{
  if (isset($_POST['submit'])) 
  {
    ...
    $id_admin = filter_var($_POST['id_admin'], FILTER_SANITIZE_STRING);  //Que du texte
    ...
    $stmt->bindValue(':id_admin', $id_admin, PDO::PARAM_STR);  //la valeur associée est une chaîne de caractères
    $stmt->execute();
