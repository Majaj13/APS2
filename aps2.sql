...
CREATE USER 'Admin'@'localhost' IDENTIFIED BY 'Btssio2017';
CREATE USER 'Etudiant'@'localhost' IDENTIFIED BY 'Btssio2017';

--
-- Déchargement des privilèges des utilisateurs
--
